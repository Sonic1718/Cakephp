...
if ($_GET['form']=='forest') {
       ...
       if ( $_GET['id'] == 1 ) {
			...
			$html = "
					...
					<div style='margin-top:-30px; text-indent:80px;'>
						<p>Type: (______________) NEW</p>
					</div>
					<div style='margin-top:-30px; text-indent:120px;'>
						<p> (______________) RENEWAL</p>
					</div>
					...
					<div style='text-indent:120px; margin-top:-20px;'>
						<p>I / We __________________________, with address at _____________________________ and
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						telephone no. ___________ hereby applies for ( Please check appropriate box ) :
						</p>
					</div>
	   ...
	   if ( $_GET['id'] == 2 ) {
	   		...
	   		$html = "
					...
					<div style='text-indent:40px;'><p>NEW OR RENEWAL (State which) __________________________________________</p></div>
					<div style='text-indent:40px; margin-top:-30px;'><p>PLACE AND DATE: __________________________________________</p></div>
					<div style='text-indent:40px; font-size:14px; margin-top:-30px;'><p>Telephone Number/E-mail address (if, there is) ______________________________</p></div>
					...
					<div style='text-indent:200px; margin-top:-30px;'><p>____________________________________________</p></div>
					...
					<div style='text-indent:-40px; margin-top:-20px;'>
						<ol>
							<li>
								I, _______________________________ of legal age , citizen of the Philippines and
								residents of ________________________ hereby apply for Permit to operate 
								_______________________
							</li>
							<br>
							<li>
								The Trade name of the plant is _________________________ located at
								 _________________________________________.
							</li>
							<br>
							<li>
								I am the owner of the said plant and I am not a holder of Timber License Agreement
								No._____________________ granted by the Director of Forest Management Bureau.
							</li>
							<br>
							<li>
							...
							<li>
								...
								<ol start='6'>
									...
									<br>
									<li>
										The total capital invested of this plant is ________________ and the total number of
										personnel employed is _______.
									</li>
									<br>
									<li>
										The ______________ to be sawn in the plant will be obtained from legitimate suppliers
										...
										______________ to be supplied as enumerated hereunder.
									</li>
								</ol>
								...
								<ol>
									<li>
										Permit No. _________________________ dated __________________ to operate this
										sawmill was granted by the Regional Executive Director of DENR-National Capital Region
										during the last fiscal year ____________.
									</li>
									<li>
									...
									<li>
										...
										__________________. (For alien retailer they must submit permit to engage in retail business)
									</li>
									<li>
										To show good faith in filing this application, I am enclosing herewith the require Oath
										Fee of P 36.00 and Application Fee of P 600.00, Permit Fee P_____________and Bond
										Deposit of P12,000 in cash or P _____________ in surety (only surety bonds posted by the
									...
									<li>
										...
										advance do not authorize me to operate the ________________l without the permit applied
									...
									<div style='text-indent:40px;'>
										I, _____________________, the applicant, first having been solemnly sworn upon my
	   ...
	   if ( $_GET['id'] == 5) {
	   		...
	   		$html = "
	   			...
	   			<br>
	   			<div style='text-indent:40px;'>_____________________________________</div>
	   			<div style='text-indent:40px; margin-top:-16px;'>
	   				<p>(Name of establishment)</p>
				</div>
				<br>
				<div style='text-indent:40px; margin-top:-20px;'>_____________________________________</div>
				...
				<div style='text-indent:280px; margin-top:-34px;'>
					<p>Supplier : __________________________</p>
				</div>
				<div style='text-indent:280px; margin-top:-34px;'>
					<p style='margin-top:14px;'>WPPP : ____________________________</p>
				</div>
				<div style='text-indent:280px; margin-top:-34px;'>
					<p style='margin-top:14px;'>Volume/Duration :_________________</p>
				</div>
	   ...
	   if ( $_GET['id'] == 6) {
	   		...
	   		$html = "
	   			...
	   			<div style='text-indent:20px; font-size:18px;'>
	   				<p>_____________________<br>&nbsp;&nbsp;&nbsp;&nbsp;(Name of Applicant)</p>
	   			</div>
	   ...
	   if ( $_GET['id'] == 7) {
	   		...
	   		$html = "
	   			...
	   			<div style='text-indent:-28px;'>
	   				<p>___________________________________________<br>(Name of establishment)</p>
	   			</div>

	   			<div style='text-indent:-28px;'>
	   				<p>___________________________________________<br>(Address)</p>
	   			</div>
