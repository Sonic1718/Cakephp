...
<div style='text-align:center; padding-top:15px; margin-left:10px; font-size:15px;'>
				...
				<div style='text-align:center; margin-top:5px; font-size:15px;'>
					<p><u>".$result['Wildlifereexport']['region']."</u></p>
				</div>
				...
				<div style='text-indent: 40px; margin-top:-50px; font-size:15px;'>
					<p>Permit No. <u>".$result['Wildlifereexport']['permit-no']."</u></p>
				</div>
				<br>
				...
				<div style='float:left; text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p><u>".$result['Wildlifereexport']['name']."</u></p>
				</div>
				<div style='float:left; margin-top:-10px; font-size:15px;'>
					<p>&nbsp;&nbsp;of&nbsp;<u>".$result['Wildlifereexport']['address']."</u></p>
				</div>
				<br>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>is authorized to transport to <u>".$result['Wildlifereexport']['transport-to']."</u>. </p>
				</div>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>the following for <u>".$result['Wildlifereexport']['transport-purposes']."</u> purposes.</p>
				</div>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
				...
				<div style='text-indent:110px; font-size:15px;'>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<u>".$result['Wildlifereexport']['transported-by']."</u>
				...
				<div style='text-indent:110px; font-size:15px;'>
					<p>Local transport fee in the amount of P <u>".$result['Wildlifereexport']['transport-fee']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;was paid under <u>".$result['Wildlifereexport']['paid']."</u>
					Official &nbsp;&nbsp;&nbsp; Receipt &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No.&nbsp;&nbsp;&nbsp;<u>".$result['Wildlifereexport']['receipt-no']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;dated <u>".$result['Wildlifereexport']['receipt-date']."</u>.</p>
				</div>
				<div style='text-indent:110px; font-size:15px;'>
				...
				<br>
															<div style='text-align:right; font-size:15px;'>
																<p><u>".$result['Wildlifereexport']['denr-officer']."</u></p>
															</div>
