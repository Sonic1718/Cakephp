...
$html = "
	   			...
	   			<ol>
	   			   <li>
					   ...
					   number), Lot .<u>".$result['Landmi']['lot']."</u> Block No. <u>".$result['Landmi']['block']."</u> Psd-<u>".$result['Landmi']['psd']."</u>,
					   Phase<u>".$result['Landmi']['phase']."</u> situated in the Barangay of <u>".$result['Landmi']['barangay']."</u>, Municipality of
					   <u>".$result['Landmi']['municipality']."</u>, Province of Metro Manila, Island of Luzon, Philippines and containing an
					   area of <u>".$result['Landmi']['area']."</u> square meters sketch of which is drawn on the back hereof.<br><br>
	   			   </li>
	   			   <li>
	   			        My name is <u>".$result['Landmi']['name']."</u>, my age is <u>".$result['Landmi']['age']."</u> years, my
						birthplace is <u>".$result['Landmi']['birthplace']."</u>, the date of my birth is
						<u>".$result['Landmi']['birth-date']."</u>. I am a citizen of the Philippines and my post office
						address is <u>".$result['Landmi']['post-address']."</u>, I am (married, single)
						and the name of my wife/husband is <u>".$result['Landmi']['spouse-name']."</u>, who is a
	   			   ...
	   			   <li>
						...
						<u>".$result['Landmi']['land-applied']."</u> and to the best of my knowledge and belief,
	   			   ...
	   			   <li>
						...
						<u>".$result['Landmi']['investment-fee']."</u>(P<u>".$result['Landmi']['total-investment']."</u>).<br><br>
	   			   </li>
	   			   <li>
						Then land applied for is/is not mortgage with the <u>".$result['Landmi']['not-mortgage']."</u>
	   			   ...
	   			   <li>
	   			   	    I am <u>".$result['Landmi']['position']."</u> a member, stockholder, officer, representative,
					    ...
					    them:<u>".$result['Landmi']['corporation-name']."</u>
					    . The said corporation, association or partnership has under its control a total area of
					    <u>".$result['Landmi']['total-hectare']."</u> hectare of public land by virtue of its <u>".$result['Landmi']['land-virtue']."</u>.<br><br>
	   			   </li>
	   			   <li>
						...
						Government, and he shall not be entitled to apply for any public land in the Philippines.<br><br>
 																									...
 																									<div style='text-align:right;'>TIN: <u>".$result['Landmi']['tin']."</u></div>
			  ...
			  <div>
			   		Republic of the Philippines)<br>
					Province of <u>".$result['Landmi']['province']."</u>)S. S.<br>
					Municipality of <u>".$result['Landmi']['municipality']."</u>)<br><br>
				</div>

				<div style='text-indent:50px;'>
									I, <u>".$result['Landmi']['your-name']."</u> the person making this
					...
					statement in the application is true and correct. SO HELP ME GOD.
			       																					...
			       																					<div style='text-align:right;'><u>".$result['Landmi']['applicant-name']."</u></div>
 																									<div style='text-align:right;'>Applicant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>

 				<br><br><br><div style='text-indent:50px;'>
 									Before me, at the place aforesaid, on this <u>".$result['Landmi']['day']."</u> day of <u>".$result['Landmi']['month']."</u>, 20<u>".$result['Landmi']['years']."</u> personally
					appeared <u>".$result['Landmi']['person-appeared']."</u>, known to be the person whose name appears in the foregoing
					application and who subscribed and sworn to this affidavit. He/She exhibited to me his/her Res.
					Cert. No. <u>".$result['Landmi']['certificate-no']."</u> Issued at <u>".$result['Landmi']['issued-at']."</u> on the <u>".$result['Landmi']['issued-day']."</u> day of
					<u>".$result['Landmi']['issued-month']."</u>, <u>".$result['Landmi']['issued-year']."</u> which shown him/her on the date of said certificate to be
					<u>".$result['Landmi']['certificate-old']."</u>years old.
 				</div>
