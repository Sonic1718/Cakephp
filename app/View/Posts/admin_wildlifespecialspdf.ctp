...
<div style='text-align:center; padding-top:15px; margin-left:10px; font-size:15px;'>
				...
				<div style='text-align:center; margin-top:5px; font-size:15px;'>
					<p><u>".$result['Wildlifespecial']['region']."</u></p>
				</div>
				...
				<div style='text-indent: 40px; margin-top:-50px; font-size:15px;'>
					<p>Permit No. <u>".$result['Wildlifespecial']['permit-no']."</u></p>
				</div>
				<br>
				...
				<div style='float:left; text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p><u>".$result['Wildlifespecial']['name']."</u></p>
				</div>
				<div style='float:left; margin-top:-10px; font-size:15px;'>
					<p>&nbsp;&nbsp;of&nbsp;<u>".$result['Wildlifespecial']['address']."</u></p>
				</div>
				<br>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>is authorized to transport to <u>".$result['Wildlifespecial']['transport-to']."</u>. </p>
				</div>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>the following for <u>".$result['Wildlifespecial']['transport-purposes']."</u> purposes.</p>
				</div>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
				...
				<div style='text-indent:110px; font-size:15px;'>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<u>".$result['Wildlifespecial']['transported-by']."</u>
				...
				<div style='text-indent:110px; font-size:15px;'>
					<p>Local transport fee in the amount of P <u>".$result['Wildlifespecial']['transport-fee']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;was paid under <u>".$result['Wildlifespecial']['paid']."</u>
					Official &nbsp;&nbsp;&nbsp; Receipt &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No.&nbsp;&nbsp;&nbsp;<u>".$result['Wildlifespecial']['receipt-no']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;dated <u>".$result['Wildlifespecial']['receipt-date']."</u>.</p>
				</div>
				<div style='text-indent:110px; font-size:15px;'>
				...
				<br>
															<div style='text-align:right; font-size:15px;'>
																<p><u>".$result['Wildlifespecial']['denr-officer']."</u></p>
															</div>
