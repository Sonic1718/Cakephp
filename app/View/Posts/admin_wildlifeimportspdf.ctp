...
<div style='text-align:center; padding-top:15px; margin-left:10px; font-size:15px;'>
				...
				<div style='text-align:center; margin-top:5px; font-size:15px;'>
					<p><u>".$result['Wildlifeimport']['region']."</u></p>
				</div>
				...
				<div style='text-indent: 40px; margin-top:-50px; font-size:15px;'>
					<p>Permit No. <u>".$result['Wildlifeimport']['permit-no']."</u></p>
				</div>
				<br>
				...
				<div style='float:left; text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p><u>".$result['Wildlifeimport']['name']."</u></p>
				</div>
				<div style='float:left; margin-top:-10px; font-size:15px;'>
					<p>&nbsp;&nbsp;of&nbsp;<u>".$result['Wildlifeimport']['address']."</u></p>
				</div>
				<br>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>is authorized to transport to <u>".$result['Wildlifeimport']['transport-to']."</u>. </p>
				</div>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
					<p>the following for <u>".$result['Wildlifeimport']['transport-purposes']."</u> purposes.</p>
				</div>
				<br>
				<div style='text-indent:70px; margin-top:-10px; font-size:15px;'>
				...
				<div style='text-indent:110px; font-size:15px;'>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<u>".$result['Wildlifeimport']['transported-by']."</u>
				...
				<div style='text-indent:110px; font-size:15px;'>
					<p>Local transport fee in the amount of P <u>".$result['Wildlifeimport']['transport-fee']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;was paid under <u>".$result['Wildlifeimport']['paid']."</u>
					Official &nbsp;&nbsp;&nbsp; Receipt &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No.&nbsp;&nbsp;&nbsp;<u>".$result['Wildlifeimport']['receipt-no']."</u><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;dated <u>".$result['Wildlifeimport']['receipt-date']."</u>.</p>
				</div>
				<div style='text-indent:110px; font-size:15px;'>
				...
				<br>
															<div style='text-align:right; font-size:15px;'>
																<p><u>".$result['Wildlifeimport']['denr-officer']."</u></p>
															</div>
