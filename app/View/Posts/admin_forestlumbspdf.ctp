...
$html = "
					...
					<div style='text-indent:40px;'><p>NEW OR RENEWAL (State which) <u>".$result['Forestwood']['type']."</u></p></div>
					<div style='text-indent:40px; margin-top:-30px;'><p>PLACE AND DATE: <u>".$result['Forestwood']['place-date']."</u></p></div>
					<div style='text-indent:40px; font-size:14px; margin-top:-30px;'><p>Telephone Number/E-mail address (if, there is) ".$result['Forestwood']['contact-email']."</p></div>
					...
					<div style='text-indent:140px; margin-top:-16px;'><p><b>APPLICATION FOR REGISTRATION AS IMPORTER/DEALER OF<br>
					...
					<div style='text-indent:-40px; margin-top:-20px;'>
						<ol>
							<li>
								I, <u>".$result['Forestwood']['name']."</u> of legal age , citizen of the Philippines and
								residents of <u>".$result['Forestwood']['address']."</u> hereby apply for Permit to operate 
								<u>".$result['Forestwood']['permit-operate']."</u>
							</li>
							<br>
							<li>
								The Trade name of the plant is <u>".$result['Forestwood']['plant-name']."</u> located at
								 <u>".$result['Forestwood']['plant-location']."</u>.
							</li>
							<br>
							<li>
								I am the owner of the said plant and I am not a holder of Timber License Agreement
								No.<u>".$result['Forestwood']['timber-license-agreement-no']."</u> granted by the Director of Forest Management Bureau.
							</li>
							<br>
							<li>
								That the actual daily rated capacity of the re-sawmill based on an eight hour shift is
								<u>".$result['Forestwood']['re-sawmill']."</u>.		
							</li>
							<br>
							<li>
								...
								<ol start='6'>
									...
									<br>
									<li>
										The total capital invested of this plant is <u>".$result['Forestwood']['capital-investment']."</u> and the total number of
										personnel employed is <u>".$result['Forestwood']['total-employed']."</u>.
									</li>
									<br>
									<li>
										The <u>".$result['Forestwood']['name-plant']."</u> to be sawn in the plant will be obtained from legitimate suppliers
										...
										<u>".$result['Forestwood']['plant-supplied']."</u> to be supplied as enumerated hereunder.
									</li>
								</ol>
								...
								<ol>
									<li>
										Permit No. <u>".$result['Forestwood']['permit-no-sawmill']."</u> dated <u>".$result['Forestwood']['operate-sawmill-date']."</u> to operate this
										sawmill was granted by the Regional Executive Director of DENR-National Capital Region
										during the last fiscal year <u>".$result['Forestwood']['year-operated']."</u>.
									</li>
									<li>
									...
									<li>
										...
										<u>".$result['Forestwood']['permit-applied-for']."</u>. (For alien retailer they must submit permit to engage in retail business)
									</li>
									<li>
										To show good faith in filing this application, I am enclosing herewith the require Oath
										Fee of P 36.00 and Application Fee of P 600.00, Permit Fee P<u>".$result['Forestwood']['permit-fee']."</u> and Bond
										Deposit of P12,000 in cash or P <u>".$result['Forestwood']['cash-bond-fee']."</u> in surety (only surety bonds posted by the
									...
									<li>
										...
										advance do not authorize me to operate the <u>".$result['Forestwood']['machine-type']."</u> without the permit applied
									...
									<li>
										...
										guilty party.
																		...
																		<div style='text-indent:320px; margin-top:-20px;'>
																			<p><u>".$result['Forestwood']['applicant-address']."</u></p>
																		</div>
									...
									<div style='text-indent:2px;'>
										...
										(<u>".$result['Forestwood']['municipality']."</u>) S.S
									</div>
									<br><br>
									<div style='text-indent:40px;'>
										I, <u>".$result['Forestwood']['applicant-name']."</u>, the applicant, first having been solemnly sworn upon my
									...
									<div style='text-indent:40px;'>
										BEFORE ME, at the City indicated in this <u>".$result['Forestwood']['day']."</u> day of ".$result['Forestwood']['month']." 20".$result['Forestwood']['year'].",
										personally appeared the same person whose name and signature with his/her Community Tax
										Certificate No. <u>".$result['Forestwood']['tax-cert-no']."</u> ISSUED ON <u>".$result['Forestwood']['issued-on']."</u> ISSUED AT <u>".$result['Forestwood']['issued-at']."</u> with
										Tax Identification (TIN) No. <u>".$result['Forestwood']['tin-no']."</u>.
									</div>																		
			  						
			  															<div style='text-indent:320px;'>
																			<p><u>".$result['Forestwood']['team-leader']."</u></p>
																		</div>
