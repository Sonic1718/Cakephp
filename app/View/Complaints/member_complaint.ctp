    ...
    $tableH = $this->Html->tableHeaders(array(
      ...
      foreach ($posts as $post) {
          ...
          $post['Complaint']['risk'],
      		...
      		$this->Html->link('View','/member/Complaints/viewcomplaint/'.$post['Complaint']['id']).' - '.
      		$this->Html->link('Delete','/member/Complaints/deletecomplaint/'.$post['Complaint']['id'],array('confirm'=>'Are you Sure you want to delete this?'))
      	);
      }
...
<?php echo $this->Html->link('Complaints Print','/member/Complaints/complaintList',array('class'=>'btn btn-default')); ?>
