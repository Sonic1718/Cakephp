...
<div class="col-lg-12">
  ...
  <h5>Date : <?= $result['Complaint']['created']; ?> (<?php echo $this->Html->link('Delete','/admin/Complaints/deletecomplaint/'.$this->params['pass'][0] , array('confirm'=>'Are you Sure you want to delete this?')); ?>)</h5>
  ...
  <div class="col-lg-6">
   ...
   <ul class="list-inline">
     <li><?= $this->Html->link('Back','/admin/complaints/complaint',array('class'=>'btn btn-default'));?></li>
     <li>
        <?php
