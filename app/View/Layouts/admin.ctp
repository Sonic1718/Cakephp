            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-power-off"></i> <?php echo $this->Html->link('Logout','/admin/users/logout'); ?></a>
                        </li>
                    </ul>
                </li>
            </ul>
    <!-- Sidebar Menu Items -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><?php echo $this->Html->link(__('Add Member'), array('controller' => 'Users', 'action' => 'member')); ?></li>
		     ...
		     <li><?php echo $this->Html->link(__('Complaints'), array('controller' => 'Complaints', 'action' => 'complaint')); ?> </li>		
                    ...
                    <li><?php echo $this->Html->link(__('Application Forms'), array('controller' => 'Pages', 'action' => 'application')); ?> </li>
