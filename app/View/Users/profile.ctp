...
if ( $this->Session->read('profile') ) {
	echo $this->Session->read('profile');
...
<div class="container">
	...
	<div class="col-md-4">
		<div class="panel panel-primary" style="box-shadow:0px 1px 1px 0px">
			<div class="panel-heading"><h3>Upload Profile</h3></div>
		...
		<?php echo $this->Form->submit('Upload',array('class'=>'btn btn-primary','style'=>'margin-top:0.2em','multiple')); ?>
